 ...
 */
guint
gf_file_manager_gen_override_properties (GObjectClass *klass, guint property_id_begin)
{
...
static void
gf_file_manager_gen_proxy_get_property (GObject      *object,
  guint         prop_id,
  GValue       *value,
...
static void
gf_file_manager_gen_proxy_set_property (GObject      *object,
  guint         prop_id,
  const GValue *value,
  GParamSpec   *pspec G_GNUC_UNUSED)
{
...
static void
gf_file_manager_gen_proxy_iface_init (GfFileManagerGenIface *iface)
{
}
...
static void
gf_file_manager_gen_skeleton_dbus_interface_flush (GDBusInterfaceSkeleton *_skeleton)
{
}
...
static void
gf_file_manager_gen_skeleton_iface_init (GfFileManagerGenIface *iface)
{
}
